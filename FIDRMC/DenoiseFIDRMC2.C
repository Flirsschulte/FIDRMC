...
/**************************************************************************************
*  The main program for FIDRMC Method for Random-valued impulse noise
***************************************************************************************/
void callDenoise(double **A1,double **A2,double **A3,double **mem1,double **mem2,double **mem3,double *filt1,double *filt2,double *filt3,int M, int N,int W) { 
   int i,j,k,l, it, loop;   
   double som, wei;
